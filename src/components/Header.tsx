...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white shadow-sm py-5 fixed top-0 left-0 w-full z-10"> {/* <-- Se eliminó px-4 y justify-between */}
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center"> {/* <-- NUEVO CONTENEDOR */}
        {/* Sección del Logo */}
